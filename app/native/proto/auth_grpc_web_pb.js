 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.org.couchers.auth.AntiBotReq,
 *   !proto.org.couchers.auth.AntiBotRes>}
 */
const methodDescriptor_Auth_AntiBot = new grpc.web.MethodDescriptor(
  '/org.couchers.auth.Auth/AntiBot',
  grpc.web.MethodType.UNARY,
  proto.org.couchers.auth.AntiBotReq,
  proto.org.couchers.auth.AntiBotRes,
  /**
   * @param {!proto.org.couchers.auth.AntiBotReq} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.org.couchers.auth.AntiBotRes.deserializeBinary
);


/**
 * @param {!proto.org.couchers.auth.AntiBotReq} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.auth.AntiBotRes)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.org.couchers.auth.AntiBotRes>|undefined}
 *     The XHR Node Readable Stream
 */
proto.org.couchers.auth.AuthClient.prototype.antiBot =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/org.couchers.auth.Auth/AntiBot',
      request,
      metadata || {},
      methodDescriptor_Auth_AntiBot,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.org.couchers.auth.AntiBotRes>}
 *     Promise that resolves to the response
 */
proto.org.couchers.auth.AuthPromiseClient.prototype.antiBot =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/org.couchers.auth.Auth/AntiBot',
      request,
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.org.couchers.auth.AntiBotPolicyReq,
 *   !proto.org.couchers.auth.AntiBotPolicyRes>}
 */
const methodDescriptor_Auth_AntiBotPolicy = new grpc.web.MethodDescriptor(
  '/org.couchers.auth.Auth/AntiBotPolicy',
  grpc.web.MethodType.UNARY,
  proto.org.couchers.auth.AntiBotPolicyReq,
  proto.org.couchers.auth.AntiBotPolicyRes,
  /**
   * @param {!proto.org.couchers.auth.AntiBotPolicyReq} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.org.couchers.auth.AntiBotPolicyRes.deserializeBinary
);


/**
 * @param {!proto.org.couchers.auth.AntiBotPolicyReq} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.auth.AntiBotPolicyRes)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.org.couchers.auth.AntiBotPolicyRes>|undefined}
 *     The XHR Node Readable Stream
 */
proto.org.couchers.auth.AuthClient.prototype.antiBotPolicy =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/org.couchers.auth.Auth/AntiBotPolicy',
      request,
      metadata || {},
      methodDescriptor_Auth_AntiBotPolicy,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.org.couchers.auth.AntiBotPolicyRes>}
 *     Promise that resolves to the response
 */
proto.org.couchers.auth.AuthPromiseClient.prototype.antiBotPolicy =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/org.couchers.auth.Auth/AntiBotPolicy',
      request,
