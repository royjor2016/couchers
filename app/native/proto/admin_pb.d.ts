...
export class SearchUsersReq extends jspb.Message {
  getUsername(): string;
  setUsername(value: string): SearchUsersReq;

  getEmail(): string;
  setEmail(value: string): SearchUsersReq;

  getName(): string;
  setName(value: string): SearchUsersReq;

  getAdminNote(): string;
  setAdminNote(value: string): SearchUsersReq;

  getCity(): string;
  setCity(value: string): SearchUsersReq;

  getMinUserId(): number;
  setMinUserId(value: number): SearchUsersReq;

  getMaxUserId(): number;
  setMaxUserId(value: number): SearchUsersReq;

  getMinBirthdate(): string;
  setMinBirthdate(value: string): SearchUsersReq;

  getMaxBirthdate(): string;
  setMaxBirthdate(value: string): SearchUsersReq;

  getMinJoinedDate(): string;
  setMinJoinedDate(value: string): SearchUsersReq;

  getMaxJoinedDate(): string;
  setMaxJoinedDate(value: string): SearchUsersReq;

  getMinLastActiveDate(): string;
  setMinLastActiveDate(value: string): SearchUsersReq;

  getMaxLastActiveDate(): string;
  setMaxLastActiveDate(value: string): SearchUsersReq;

  getGendersList(): Array<string>;
  setGendersList(value: Array<string>): SearchUsersReq;
  clearGendersList(): SearchUsersReq;
  addGenders(value: string, index?: number): SearchUsersReq;

  getLanguageCodesList(): Array<string>;
  setLanguageCodesList(value: Array<string>): SearchUsersReq;
  clearLanguageCodesList(): SearchUsersReq;
  addLanguageCodes(value: string, index?: number): SearchUsersReq;

  getIsDeleted(): google_protobuf_wrappers_pb.BoolValue | undefined;
  setIsDeleted(value?: google_protobuf_wrappers_pb.BoolValue): SearchUsersReq;
  hasIsDeleted(): boolean;
  clearIsDeleted(): SearchUsersReq;

  getIsBanned(): google_protobuf_wrappers_pb.BoolValue | undefined;
  setIsBanned(value?: google_protobuf_wrappers_pb.BoolValue): SearchUsersReq;
  hasIsBanned(): boolean;
  clearIsBanned(): SearchUsersReq;

  getHasAvatar(): google_protobuf_wrappers_pb.BoolValue | undefined;
  setHasAvatar(value?: google_protobuf_wrappers_pb.BoolValue): SearchUsersReq;
  hasHasAvatar(): boolean;
  clearHasAvatar(): SearchUsersReq;

  getPageSize(): number;
  setPageSize(value: number): SearchUsersReq;

  getPageToken(): string;
  setPageToken(value: string): SearchUsersReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SearchUsersReq.AsObject;
  static toObject(includeInstance: boolean, msg: SearchUsersReq): SearchUsersReq.AsObject;
  static serializeBinaryToWriter(message: SearchUsersReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SearchUsersReq;
  static deserializeBinaryFromReader(message: SearchUsersReq, reader: jspb.BinaryReader): SearchUsersReq;
}

export namespace SearchUsersReq {
  export type AsObject = {
    username: string,
    email: string,
    name: string,
    ...
    minBirthdate: string,
    maxBirthdate: string,
    minJoinedDate: string,
    maxJoinedDate: string,
    minLastActiveDate: string,
    maxLastActiveDate: string,
    gendersList: Array<string>,
    languageCodesList: Array<string>,
    isDeleted?: google_protobuf_wrappers_pb.BoolValue.AsObject,
    isBanned?: google_protobuf_wrappers_pb.BoolValue.AsObject,
    hasAvatar?: google_protobuf_wrappers_pb.BoolValue.AsObject,
    pageSize: number,
    pageToken: string,
  }
}

export class SearchUsersRes extends jspb.Message {
  getUsersList(): Array<UserDetails>;
  setUsersList(value: Array<UserDetails>): SearchUsersRes;
  clearUsersList(): SearchUsersRes;
  addUsers(value?: UserDetails, index?: number): UserDetails;

  getNextPageToken(): string;
  setNextPageToken(value: string): SearchUsersRes;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SearchUsersRes.AsObject;
  static toObject(includeInstance: boolean, msg: SearchUsersRes): SearchUsersRes.AsObject;
  static serializeBinaryToWriter(message: SearchUsersRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SearchUsersRes;
  static deserializeBinaryFromReader(message: SearchUsersRes, reader: jspb.BinaryReader): SearchUsersRes;
}

export namespace SearchUsersRes {
  export type AsObject = {
    usersList: Array<UserDetails.AsObject>,
