...
export class AdminClient {
  ...
  searchUsers(
    request: admin_pb.SearchUsersReq,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: admin_pb.SearchUsersRes) => void
  ): grpcWeb.ClientReadableStream<admin_pb.SearchUsersRes>;
...
export class AdminPromiseClient {
  ...
  searchUsers(
    request: admin_pb.SearchUsersReq,
    metadata?: grpcWeb.Metadata
  ): Promise<admin_pb.SearchUsersRes>;
