...
export class AuthClient {
  ...
  antiBot(
    request: auth_pb.AntiBotReq,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: auth_pb.AntiBotRes) => void
  ): grpcWeb.ClientReadableStream<auth_pb.AntiBotRes>;

  antiBotPolicy(
    request: auth_pb.AntiBotPolicyReq,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: auth_pb.AntiBotPolicyRes) => void
  ): grpcWeb.ClientReadableStream<auth_pb.AntiBotPolicyRes>;
...
export class AuthPromiseClient {
  ...
  antiBot(
    request: auth_pb.AntiBotReq,
    metadata?: grpcWeb.Metadata
  ): Promise<auth_pb.AntiBotRes>;

  antiBotPolicy(
    request: auth_pb.AntiBotPolicyReq,
    metadata?: grpcWeb.Metadata
  ): Promise<auth_pb.AntiBotPolicyRes>;
