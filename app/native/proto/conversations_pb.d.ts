...
export class MuteInfo extends jspb.Message {
  getMuted(): boolean;
  setMuted(value: boolean): MuteInfo;

  getMutedUntil(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setMutedUntil(value?: google_protobuf_timestamp_pb.Timestamp): MuteInfo;
  hasMutedUntil(): boolean;
  clearMutedUntil(): MuteInfo;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MuteInfo.AsObject;
  static toObject(includeInstance: boolean, msg: MuteInfo): MuteInfo.AsObject;
  static serializeBinaryToWriter(message: MuteInfo, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MuteInfo;
  static deserializeBinaryFromReader(message: MuteInfo, reader: jspb.BinaryReader): MuteInfo;
}

export namespace MuteInfo {
  export type AsObject = {
    muted: boolean,
    mutedUntil?: google_protobuf_timestamp_pb.Timestamp.AsObject,
  }
}
...
export class GroupChat extends jspb.Message {
  ...
  getMuteInfo(): MuteInfo | undefined;
  setMuteInfo(value?: MuteInfo): GroupChat;
  hasMuteInfo(): boolean;
  clearMuteInfo(): GroupChat;

  getCanMessage(): boolean;
  setCanMessage(value: boolean): GroupChat;
...
export class MuteGroupChatReq extends jspb.Message {
  getGroupChatId(): number;
  setGroupChatId(value: number): MuteGroupChatReq;

  getUnmute(): boolean;
  setUnmute(value: boolean): MuteGroupChatReq;

  getForever(): boolean;
  setForever(value: boolean): MuteGroupChatReq;

  getForDuration(): google_protobuf_duration_pb.Duration | undefined;
  setForDuration(value?: google_protobuf_duration_pb.Duration): MuteGroupChatReq;
  hasForDuration(): boolean;
  clearForDuration(): MuteGroupChatReq;

  getDurationCase(): MuteGroupChatReq.DurationCase;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MuteGroupChatReq.AsObject;
  static toObject(includeInstance: boolean, msg: MuteGroupChatReq): MuteGroupChatReq.AsObject;
  static serializeBinaryToWriter(message: MuteGroupChatReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MuteGroupChatReq;
  static deserializeBinaryFromReader(message: MuteGroupChatReq, reader: jspb.BinaryReader): MuteGroupChatReq;
}

export namespace MuteGroupChatReq {
  export type AsObject = {
    groupChatId: number,
    unmute: boolean,
    forever: boolean,
    forDuration?: google_protobuf_duration_pb.Duration.AsObject,
  }
...
export class SendDirectMessageReq extends jspb.Message {
  getRecipientUserId(): number;
  setRecipientUserId(value: number): SendDirectMessageReq;

  getText(): string;
  setText(value: string): SendDirectMessageReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SendDirectMessageReq.AsObject;
  static toObject(includeInstance: boolean, msg: SendDirectMessageReq): SendDirectMessageReq.AsObject;
  static serializeBinaryToWriter(message: SendDirectMessageReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SendDirectMessageReq;
  static deserializeBinaryFromReader(message: SendDirectMessageReq, reader: jspb.BinaryReader): SendDirectMessageReq;
}

export namespace SendDirectMessageReq {
  export type AsObject = {
...
export class SendDirectMessageRes extends jspb.Message {
  getGroupChatId(): number;
  setGroupChatId(value: number): SendDirectMessageRes;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SendDirectMessageRes.AsObject;
  static toObject(includeInstance: boolean, msg: SendDirectMessageRes): SendDirectMessageRes.AsObject;
  static serializeBinaryToWriter(message: SendDirectMessageRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SendDirectMessageRes;
  static deserializeBinaryFromReader(message: SendDirectMessageRes, reader: jspb.BinaryReader): SendDirectMessageRes;
}

export namespace SendDirectMessageRes {
  export type AsObject = {
    groupChatId: number,
  }
}
