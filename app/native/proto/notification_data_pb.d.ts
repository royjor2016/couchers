...
export class HostRequestReminder extends jspb.Message {
  getHostRequest(): requests_pb.HostRequest | undefined;
  setHostRequest(value?: requests_pb.HostRequest): HostRequestReminder;
  hasHostRequest(): boolean;
  clearHostRequest(): HostRequestReminder;

  getSurfer(): api_pb.User | undefined;
  setSurfer(value?: api_pb.User): HostRequestReminder;
  hasSurfer(): boolean;
  clearSurfer(): HostRequestReminder;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): HostRequestReminder.AsObject;
  static toObject(includeInstance: boolean, msg: HostRequestReminder): HostRequestReminder.AsObject;
  static serializeBinaryToWriter(message: HostRequestReminder, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): HostRequestReminder;
  static deserializeBinaryFromReader(message: HostRequestReminder, reader: jspb.BinaryReader): HostRequestReminder;
}

export namespace HostRequestReminder {
  export type AsObject = {
    hostRequest?: requests_pb.HostRequest.AsObject,
    surfer?: api_pb.User.AsObject,
  }
