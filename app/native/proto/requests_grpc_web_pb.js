 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.org.couchers.api.requests.SetHostRequestArchiveStatusReq,
 *   !proto.org.couchers.api.requests.SetHostRequestArchiveStatusRes>}
 */
const methodDescriptor_Requests_SetHostRequestArchiveStatus = new grpc.web.MethodDescriptor(
  '/org.couchers.api.requests.Requests/SetHostRequestArchiveStatus',
  grpc.web.MethodType.UNARY,
  proto.org.couchers.api.requests.SetHostRequestArchiveStatusReq,
  proto.org.couchers.api.requests.SetHostRequestArchiveStatusRes,
  /**
   * @param {!proto.org.couchers.api.requests.SetHostRequestArchiveStatusReq} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.org.couchers.api.requests.SetHostRequestArchiveStatusRes.deserializeBinary
);


/**
 * @param {!proto.org.couchers.api.requests.SetHostRequestArchiveStatusReq} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.requests.SetHostRequestArchiveStatusRes)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.org.couchers.api.requests.SetHostRequestArchiveStatusRes>|undefined}
 *     The XHR Node Readable Stream
 */
proto.org.couchers.api.requests.RequestsClient.prototype.setHostRequestArchiveStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/org.couchers.api.requests.Requests/SetHostRequestArchiveStatus',
      request,
      metadata || {},
      methodDescriptor_Requests_SetHostRequestArchiveStatus,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.org.couchers.api.requests.SetHostRequestArchiveStatusRes>}
 *     Promise that resolves to the response
 */
proto.org.couchers.api.requests.RequestsPromiseClient.prototype.setHostRequestArchiveStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/org.couchers.api.requests.Requests/SetHostRequestArchiveStatus',
      request,
