...
export class SetHostRequestArchiveStatusReq extends jspb.Message {
  getHostRequestId(): number;
  setHostRequestId(value: number): SetHostRequestArchiveStatusReq;

  getIsArchived(): boolean;
  setIsArchived(value: boolean): SetHostRequestArchiveStatusReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SetHostRequestArchiveStatusReq.AsObject;
  static toObject(includeInstance: boolean, msg: SetHostRequestArchiveStatusReq): SetHostRequestArchiveStatusReq.AsObject;
  static serializeBinaryToWriter(message: SetHostRequestArchiveStatusReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SetHostRequestArchiveStatusReq;
  static deserializeBinaryFromReader(message: SetHostRequestArchiveStatusReq, reader: jspb.BinaryReader): SetHostRequestArchiveStatusReq;
}

export namespace SetHostRequestArchiveStatusReq {
  export type AsObject = {
    hostRequestId: number,
    isArchived: boolean,
  }
...
export class SetHostRequestArchiveStatusRes extends jspb.Message {
  getHostRequestId(): number;
  setHostRequestId(value: number): SetHostRequestArchiveStatusRes;

  getIsArchived(): boolean;
  setIsArchived(value: boolean): SetHostRequestArchiveStatusRes;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SetHostRequestArchiveStatusRes.AsObject;
  static toObject(includeInstance: boolean, msg: SetHostRequestArchiveStatusRes): SetHostRequestArchiveStatusRes.AsObject;
  static serializeBinaryToWriter(message: SetHostRequestArchiveStatusRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SetHostRequestArchiveStatusRes;
  static deserializeBinaryFromReader(message: SetHostRequestArchiveStatusRes, reader: jspb.BinaryReader): SetHostRequestArchiveStatusRes;
}

export namespace SetHostRequestArchiveStatusRes {
  export type AsObject = {
    hostRequestId: number,
    isArchived: boolean,
  }
...
export class ListHostRequestsReq extends jspb.Message {
  ...
  getOnlyArchived(): boolean;
  setOnlyArchived(value: boolean): ListHostRequestsReq;
  hasOnlyArchived(): boolean;
  clearOnlyArchived(): ListHostRequestsReq;
...
export namespace ListHostRequestsReq {
  ...
  export enum OnlyArchivedCase { 
    _ONLY_ARCHIVED_NOT_SET = 0,
    ONLY_ARCHIVED = 6,
  }
}
