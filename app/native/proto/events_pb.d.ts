...
export class Event extends jspb.Message {
  ...
  setIsCancelled(value: boolean): Event;

  getIsDeleted(): boolean;
  setIsDeleted(value: boolean): Event;
  ...
  setThread(value?: threads_pb.Thread): Event;
  hasThread(): boolean;
  clearThread(): Event;
...
export class UpdateEventReq extends jspb.Message {
  ...
  getShouldNotify(): boolean;
  setShouldNotify(value: boolean): UpdateEventReq;
...
export class CancelEventReq extends jspb.Message {
  getEventId(): number;
  setEventId(value: number): CancelEventReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CancelEventReq.AsObject;
  static toObject(includeInstance: boolean, msg: CancelEventReq): CancelEventReq.AsObject;
  static serializeBinaryToWriter(message: CancelEventReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CancelEventReq;
  static deserializeBinaryFromReader(message: CancelEventReq, reader: jspb.BinaryReader): CancelEventReq;
}

export namespace CancelEventReq {
  export type AsObject = {
    eventId: number,
  }
}

export class RequestCommunityInviteReq extends jspb.Message {
  getEventId(): number;
  setEventId(value: number): RequestCommunityInviteReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RequestCommunityInviteReq.AsObject;
  static toObject(includeInstance: boolean, msg: RequestCommunityInviteReq): RequestCommunityInviteReq.AsObject;
  static serializeBinaryToWriter(message: RequestCommunityInviteReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RequestCommunityInviteReq;
  static deserializeBinaryFromReader(message: RequestCommunityInviteReq, reader: jspb.BinaryReader): RequestCommunityInviteReq;
}

export namespace RequestCommunityInviteReq {
  export type AsObject = {
    eventId: number,
  }
}
...
export class ListMyEventsReq extends jspb.Message {
  ...
  setMyCommunities(value: boolean): ListMyEventsReq;

  getIncludeCancelled(): boolean;
  setIncludeCancelled(value: boolean): ListMyEventsReq;
  ...
  setPageNumber(value: number): ListMyEventsReq;

  getPaginationCase(): ListMyEventsReq.PaginationCase;
...
export class ListMyEventsRes extends jspb.Message {
  ...
  setTotalItems(value: number): ListMyEventsRes;
...
export class ListAllEventsReq extends jspb.Message {
  getPast(): boolean;
  setPast(value: boolean): ListAllEventsReq;

  getIncludeCancelled(): boolean;
  setIncludeCancelled(value: boolean): ListAllEventsReq;

  getPageSize(): number;
  setPageSize(value: number): ListAllEventsReq;

  getPageToken(): string;
  setPageToken(value: string): ListAllEventsReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ListAllEventsReq.AsObject;
  static toObject(includeInstance: boolean, msg: ListAllEventsReq): ListAllEventsReq.AsObject;
  static serializeBinaryToWriter(message: ListAllEventsReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ListAllEventsReq;
  static deserializeBinaryFromReader(message: ListAllEventsReq, reader: jspb.BinaryReader): ListAllEventsReq;
}

export namespace ListAllEventsReq {
  export type AsObject = {
    past: boolean,
    includeCancelled: boolean,
    pageSize: number,
...
export class ListAllEventsRes extends jspb.Message {
  getEventsList(): Array<Event>;
  setEventsList(value: Array<Event>): ListAllEventsRes;
  clearEventsList(): ListAllEventsRes;
  addEvents(value?: Event, index?: number): Event;

  getNextPageToken(): string;
  setNextPageToken(value: string): ListAllEventsRes;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ListAllEventsRes.AsObject;
  static toObject(includeInstance: boolean, msg: ListAllEventsRes): ListAllEventsRes.AsObject;
  static serializeBinaryToWriter(message: ListAllEventsRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ListAllEventsRes;
  static deserializeBinaryFromReader(message: ListAllEventsRes, reader: jspb.BinaryReader): ListAllEventsRes;
}

export namespace ListAllEventsRes {
  export type AsObject = {
    eventsList: Array<Event.AsObject>,
    nextPageToken: string,
  }
...
export class ListEventOccurrencesReq extends jspb.Message {
  ...
  getIncludeCancelled(): boolean;
  setIncludeCancelled(value: boolean): ListEventOccurrencesReq;
