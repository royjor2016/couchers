...
export class ConversationsClient {
  ...
  sendDirectMessage(
    request: conversations_pb.SendDirectMessageReq,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: conversations_pb.SendDirectMessageRes) => void
  ): grpcWeb.ClientReadableStream<conversations_pb.SendDirectMessageRes>;
...
export class ConversationsPromiseClient {
  ...
  sendDirectMessage(
    request: conversations_pb.SendDirectMessageReq,
    metadata?: grpcWeb.Metadata
  ): Promise<conversations_pb.SendDirectMessageRes>;
