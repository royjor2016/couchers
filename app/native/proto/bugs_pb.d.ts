...
export class ScreenResolution extends jspb.Message {
  getWidth(): number;
  setWidth(value: number): ScreenResolution;

  getHeight(): number;
  setHeight(value: number): ScreenResolution;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ScreenResolution.AsObject;
  static toObject(includeInstance: boolean, msg: ScreenResolution): ScreenResolution.AsObject;
  static serializeBinaryToWriter(message: ScreenResolution, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ScreenResolution;
  static deserializeBinaryFromReader(message: ScreenResolution, reader: jspb.BinaryReader): ScreenResolution;
}
...
export class ReportBugReq extends jspb.Message {
  ...
  getScreenResolution(): ScreenResolution | undefined;
  setScreenResolution(value?: ScreenResolution): ReportBugReq;
  hasScreenResolution(): boolean;
  clearScreenResolution(): ReportBugReq;
...
export namespace ReportBugReq {
  export type AsObject = {
    ...
    userAgent: string,
    page: string,
    screenResolution?: ScreenResolution.AsObject,
  }
}
