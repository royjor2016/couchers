 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.conversations.ListGroupChatsRes)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.conversations.GroupChat)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.conversations.GetUpdatesRes)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.conversations.GetGroupChatMessagesRes)}
 *     callback The callback function(error, response)
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.org.couchers.api.conversations.MuteGroupChatReq,
 *   !proto.google.protobuf.Empty>}
 */
const methodDescriptor_Conversations_MuteGroupChat = new grpc.web.MethodDescriptor(
  '/org.couchers.api.conversations.Conversations/MuteGroupChat',
  grpc.web.MethodType.UNARY,
  proto.org.couchers.api.conversations.MuteGroupChatReq,
  google_protobuf_empty_pb.Empty,
  /**
   * @param {!proto.org.couchers.api.conversations.MuteGroupChatReq} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.org.couchers.api.conversations.MuteGroupChatReq} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.google.protobuf.Empty)}
 ...
 *     The XHR Node Readable Stream
 */
proto.org.couchers.api.conversations.ConversationsClient.prototype.muteGroupChat =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/org.couchers.api.conversations.Conversations/MuteGroupChat',
      request,
      metadata || {},
      methodDescriptor_Conversations_MuteGroupChat,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.org.couchers.api.conversations.ConversationsPromiseClient.prototype.muteGroupChat =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/org.couchers.api.conversations.Conversations/MuteGroupChat',
      request,
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.org.couchers.api.conversations.SendDirectMessageReq,
 *   !proto.org.couchers.api.conversations.SendDirectMessageRes>}
 */
const methodDescriptor_Conversations_SendDirectMessage = new grpc.web.MethodDescriptor(
  '/org.couchers.api.conversations.Conversations/SendDirectMessage',
  grpc.web.MethodType.UNARY,
  proto.org.couchers.api.conversations.SendDirectMessageReq,
  proto.org.couchers.api.conversations.SendDirectMessageRes,
  /**
   * @param {!proto.org.couchers.api.conversations.SendDirectMessageReq} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.org.couchers.api.conversations.SendDirectMessageRes.deserializeBinary
);


/**
 * @param {!proto.org.couchers.api.conversations.SendDirectMessageReq} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.conversations.SendDirectMessageRes)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.org.couchers.api.conversations.SendDirectMessageRes>|undefined}
 *     The XHR Node Readable Stream
 */
proto.org.couchers.api.conversations.ConversationsClient.prototype.sendDirectMessage =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/org.couchers.api.conversations.Conversations/SendDirectMessage',
      request,
      metadata || {},
      methodDescriptor_Conversations_SendDirectMessage,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.org.couchers.api.conversations.SendDirectMessageRes>}
 *     Promise that resolves to the response
 */
proto.org.couchers.api.conversations.ConversationsPromiseClient.prototype.sendDirectMessage =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/org.couchers.api.conversations.Conversations/SendDirectMessage',
      request,
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.conversations.SearchMessagesRes)}
 *     callback The callback function(error, response)
