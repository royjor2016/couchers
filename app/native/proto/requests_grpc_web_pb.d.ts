...
export class RequestsClient {
  ...
  setHostRequestArchiveStatus(
    request: requests_pb.SetHostRequestArchiveStatusReq,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: requests_pb.SetHostRequestArchiveStatusRes) => void
  ): grpcWeb.ClientReadableStream<requests_pb.SetHostRequestArchiveStatusRes>;
...
export class RequestsPromiseClient {
  ...
  setHostRequestArchiveStatus(
    request: requests_pb.SetHostRequestArchiveStatusReq,
    metadata?: grpcWeb.Metadata
  ): Promise<requests_pb.SetHostRequestArchiveStatusRes>;
