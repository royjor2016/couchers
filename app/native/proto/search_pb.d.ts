...
export class SearchUser extends jspb.Message {
  getUserId(): number;
  setUserId(value: number): SearchUser;

  getUsername(): string;
  setUsername(value: string): SearchUser;

  getName(): string;
  setName(value: string): SearchUser;

  getCity(): string;
  setCity(value: string): SearchUser;

  getHasCompletedProfile(): boolean;
  setHasCompletedProfile(value: boolean): SearchUser;

  getLat(): number;
  setLat(value: number): SearchUser;

  getLng(): number;
  setLng(value: number): SearchUser;

  getProfileSnippet(): string;
  setProfileSnippet(value: string): SearchUser;

  getNumReferences(): number;
  setNumReferences(value: number): SearchUser;

  getGender(): string;
  setGender(value: string): SearchUser;

  getAge(): number;
  setAge(value: number): SearchUser;

  getLastActive(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setLastActive(value?: google_protobuf_timestamp_pb.Timestamp): SearchUser;
  hasLastActive(): boolean;
  clearLastActive(): SearchUser;

  getHostingStatus(): api_pb.HostingStatus;
  setHostingStatus(value: api_pb.HostingStatus): SearchUser;

  getMeetupStatus(): api_pb.MeetupStatus;
  setMeetupStatus(value: api_pb.MeetupStatus): SearchUser;

  getAvatarUrl(): string;
  setAvatarUrl(value: string): SearchUser;

  getAvatarThumbnailUrl(): string;
  setAvatarThumbnailUrl(value: string): SearchUser;

  getHasStrongVerification(): boolean;
  setHasStrongVerification(value: boolean): SearchUser;

  getInsufficientData(): requests_pb.ResponseRateInsufficientData | undefined;
  setInsufficientData(value?: requests_pb.ResponseRateInsufficientData): SearchUser;
  hasInsufficientData(): boolean;
  clearInsufficientData(): SearchUser;

  getLow(): requests_pb.ResponseRateLow | undefined;
  setLow(value?: requests_pb.ResponseRateLow): SearchUser;
  hasLow(): boolean;
  clearLow(): SearchUser;

  getSome(): requests_pb.ResponseRateSome | undefined;
  setSome(value?: requests_pb.ResponseRateSome): SearchUser;
  hasSome(): boolean;
  clearSome(): SearchUser;

  getMost(): requests_pb.ResponseRateMost | undefined;
  setMost(value?: requests_pb.ResponseRateMost): SearchUser;
  hasMost(): boolean;
  clearMost(): SearchUser;

  getAlmostAll(): requests_pb.ResponseRateAlmostAll | undefined;
  setAlmostAll(value?: requests_pb.ResponseRateAlmostAll): SearchUser;
  hasAlmostAll(): boolean;
  clearAlmostAll(): SearchUser;

  getResponseRateCase(): SearchUser.ResponseRateCase;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SearchUser.AsObject;
  static toObject(includeInstance: boolean, msg: SearchUser): SearchUser.AsObject;
  static serializeBinaryToWriter(message: SearchUser, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SearchUser;
  static deserializeBinaryFromReader(message: SearchUser, reader: jspb.BinaryReader): SearchUser;
}
...
export class UserSearchV2Res extends jspb.Message {
  getResultsList(): Array<SearchUser>;
  setResultsList(value: Array<SearchUser>): UserSearchV2Res;
  clearResultsList(): UserSearchV2Res;
  addResults(value?: SearchUser, index?: number): SearchUser;

  getNextPageToken(): string;
  setNextPageToken(value: string): UserSearchV2Res;

  getTotalItems(): number;
  setTotalItems(value: number): UserSearchV2Res;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): UserSearchV2Res.AsObject;
  static toObject(includeInstance: boolean, msg: UserSearchV2Res): UserSearchV2Res.AsObject;
  static serializeBinaryToWriter(message: UserSearchV2Res, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UserSearchV2Res;
  static deserializeBinaryFromReader(message: UserSearchV2Res, reader: jspb.BinaryReader): UserSearchV2Res;
}

export namespace UserSearchV2Res {
  export type AsObject = {
    resultsList: Array<SearchUser.AsObject>,
    nextPageToken: string,
    totalItems: number,
  }
}
