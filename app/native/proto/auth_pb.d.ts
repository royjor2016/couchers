...
export class AntiBotReq extends jspb.Message {
  getToken(): string;
  setToken(value: string): AntiBotReq;

  getAction(): string;
  setAction(value: string): AntiBotReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AntiBotReq.AsObject;
  static toObject(includeInstance: boolean, msg: AntiBotReq): AntiBotReq.AsObject;
  static serializeBinaryToWriter(message: AntiBotReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AntiBotReq;
  static deserializeBinaryFromReader(message: AntiBotReq, reader: jspb.BinaryReader): AntiBotReq;
}

export namespace AntiBotReq {
  export type AsObject = {
    token: string,
    action: string,
  }
...
export class AntiBotRes extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AntiBotRes.AsObject;
  static toObject(includeInstance: boolean, msg: AntiBotRes): AntiBotRes.AsObject;
  static serializeBinaryToWriter(message: AntiBotRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AntiBotRes;
  static deserializeBinaryFromReader(message: AntiBotRes, reader: jspb.BinaryReader): AntiBotRes;
}

export namespace AntiBotRes {
  export type AsObject = {
  }
}

export class AntiBotPolicyReq extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AntiBotPolicyReq.AsObject;
  static toObject(includeInstance: boolean, msg: AntiBotPolicyReq): AntiBotPolicyReq.AsObject;
  static serializeBinaryToWriter(message: AntiBotPolicyReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AntiBotPolicyReq;
  static deserializeBinaryFromReader(message: AntiBotPolicyReq, reader: jspb.BinaryReader): AntiBotPolicyReq;
}

export namespace AntiBotPolicyReq {
  export type AsObject = {
  }
}

export class AntiBotPolicyRes extends jspb.Message {
  getShouldAntibot(): boolean;
  setShouldAntibot(value: boolean): AntiBotPolicyRes;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AntiBotPolicyRes.AsObject;
  static toObject(includeInstance: boolean, msg: AntiBotPolicyRes): AntiBotPolicyRes.AsObject;
  static serializeBinaryToWriter(message: AntiBotPolicyRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AntiBotPolicyRes;
  static deserializeBinaryFromReader(message: AntiBotPolicyRes, reader: jspb.BinaryReader): AntiBotPolicyRes;
}

export namespace AntiBotPolicyRes {
  export type AsObject = {
    shouldAntibot: boolean,
  }
}
