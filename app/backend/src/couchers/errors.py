...
ALREADY_LEFT_HOST_REQUEST_FEEDBACK = "You have already left feedback for this host request!"
AT_LEAST_TWO_USERS_REQUIRED = "At least 2 users must be specified"
...
EVENT_CANT_REMOVE_OWNER_AS_ORGANIZER = "You cannot remove the event owner as an organizer."
...
INVALID_WEBSITE_URL = "Invalid website URL or text, make sure URL starts with \"https://\", and that the text is included in the URL."  # fmt: skip
INVITE_CODE_NOT_FOUND = "Invite code not found."
INVITE_PERMISSION_DENIED = "You're not allowed to invite users."
QUERY_IS_EMPTY = "Query cannot be empty."
...
NOT_A_VOLUNTEER = "You are currently not registered as a volunteer, if this is wrong, please contact us."
NOT_DONATED = "Please complete donation to get phone verified."
NOT_FRIENDS = "You aren't friends with that user!"
